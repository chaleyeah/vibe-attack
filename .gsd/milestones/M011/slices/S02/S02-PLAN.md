...
- [x] **T02: Run wizard UAT scenarios A–D on all four distros and record SCENARIO_* outcomes** `est:human-bound; agent verification ~20m`
...
- [x] **T03: Run final end-to-end UAT on all four distros against the published AppImage and close the proof gate** `est:human-bound; agent verification ~20m; gated on S04 completion`
