...
- [ ] **T02: Implement egui editor panel: category/macro lists, edit form, CRUD buttons, Save with SwitchProfile dispatch** `est:2h`
...
- [ ] **T03: Add state-machine roundtrip integration test and verify full slice acceptance** `est:1h`
